...
def lateGame(starting_words, num, key):
    ...
    while playing:
        ...
        with open('possible_answers.txt') as possible_answers:
        ...
        while not win_state:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_BACKSPACE:
                        ...
                        with open('possible_guesses.txt') as possible_guesses:
            ...
            for guess in guesses:
                if guess == answer:
                    ...
                    games += 1
                    correct += 1
                    with open('late_game_recognition_top_times.txt', 'r+') as top_times:
                    ...
                    open('late_game_recognition_top_times.txt', 'w').close()
                    with open('late_game_recognition_top_times.txt', 'w') as top_times:
